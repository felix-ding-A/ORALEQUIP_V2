...
export const blogPosts: BlogPost[] = [
    {
        ...
        featured: true,
        body: [
            block('The landscape of dental technology is evolving at an unprecedented pace. In our clinic at ORALEQUIP, we have been at the forefront of adopting transformative technologies, and 2026 promises even more exciting developments for the profession.', 'b1'),
    ...
    },
    {
        ...
        readTime: '6 min read',
        body: [
            block('Selecting the right composite resin for each clinical situation is one of the most impactful decisions a restorative dentist makes daily. With dozens of products on the market, the choice can be overwhelming. Based on our clinical experience at ORALEQUIP, here is a practical framework.', 'b1'),
    ...
    },
    {
        ...
        body: [
            ...
            block('The transition to fully automated washer-disinfectors for instrument reprocessing has been one of the most significant quality improvements we implemented at ORALEQUIP. Compared to manual cleaning, validated washer-disinfectors deliver reproducible cleaning cycles that are documented, traceable, and far less dependent on operator compliance.', 'b2'),
        ],
    },
    {
        _id: '5',
    ...
    },
    {
        ...
        body: [
            ...
            block("At ORALEQUIP, we began our sustainability journey by conducting a waste audit — simply cataloguing every category of waste by volume over one month. The results were eye-opening. Single-use barriers accounted for the largest volume, followed by impression materials and sterilisation pouches.", 'b2'),
        ],
    },
];
